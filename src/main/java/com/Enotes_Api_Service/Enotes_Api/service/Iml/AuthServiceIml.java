...
public class AuthServiceIml implements AuthService {
    ...
    private void sendEmailForRegister(User savedUser, String url) throws MessagingException, UnsupportedEncodingException {
    ...
    public LoginResponse login(LoginRequest user) {
        try {
            ...
            return LoginResponse.builder()
                    .user(modelMapper.map(customUserDetail.getUser(), UserResponse.class))
                    .token(token)
                    .build();
